...
public enum CertificatePolicy
{
    ...
    /// 未指定策略
    /// </summary>
    [Display(Name = "CertificatePolicy_None", ResourceType = typeof(EnumResources))]
    None = 0,
    ...
    /// </summary>
    [Display(Name = "CertificatePolicy_AnyPolicy", ResourceType = typeof(EnumResources))]
    AnyPolicy,
    ...
    /// </summary>
    [Display(Name = "CertificatePolicy_DomainValidated", ResourceType = typeof(EnumResources))]
    DomainValidated,
    ...
    /// CA/Browser Forum 基线要求定义
    /// </summary>
    [Display(Name = "CertificatePolicy_OrganizationValidated", ResourceType = typeof(EnumResources))]
    ...
    /// </summary>
    [Display(Name = "CertificatePolicy_ExtendedValidation", ResourceType = typeof(EnumResources))]
    ExtendedValidation,
    ...
    /// </summary>
    [Display(Name = "CertificatePolicy_MicrosoftDocumentSigning", ResourceType = typeof(EnumResources))]
